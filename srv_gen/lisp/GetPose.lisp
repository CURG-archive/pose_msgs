...
(cl:defmethod cl:initialize-instance :after ((m <GetPose-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetPose-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pose_msgs-srv:<GetPose-request> is deprecated: use pose_msgs-srv:GetPose-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <GetPose-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetPose-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pose_msgs-srv:<GetPose-response> is deprecated: use pose_msgs-srv:GetPose-response instead.")))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <GetPose-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pose_msgs-srv:pose-val is deprecated.  Use pose_msgs-srv:pose instead.")
  (pose m))
